          ...
          <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {certificationsData.map((cert) => (
                <span
                  key={cert.name}
                  className="rounded-md bg-gray-100 px-2.5 py-1 text-sm font-medium text-gray-800 ring-1 ring-inset ring-gray-200 dark:bg-gray-800 dark:text-gray-300 dark:ring-gray-700"
                >
